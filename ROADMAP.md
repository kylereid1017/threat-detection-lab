...
| **Tier 3: Agent Exposure Review & Capability Composition** | **Verified** | `tools/agent_graph/exposure_review.py` (91% coverage), `composition.py` (99% coverage), `marginal.py` (97% coverage). Evaluated across 336 real configurations; the repository suite is 545 tests. | Capability taxonomy evaluated against 23 labeled benchmarks (precision 0.73, recall 0.53); measures potential capability co-occurrence across static configurations, not runtime telemetry. |
