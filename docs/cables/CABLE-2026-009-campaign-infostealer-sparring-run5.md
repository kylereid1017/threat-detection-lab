---
cable_id: CABLE-2026-009
date: 2026-09-03
author: Kyle Reid
campaign_id: CAMP-2026-005
campaign_name: Infostealer-Sparring-Run5
...
# Threat Intelligence Cable: CABLE-2026-009

**TLP:** CLEAR | **Date:** 2026-09-03 | **Author:** Kyle Reid  
**Subject:** Multi-Stage Intrusion Campaign Post-Mortem & Defense-in-Depth Analysis: `Infostealer-Sparring-Run5`  
**Campaign ID:** `CAMP-2026-005` | **Outcome:** **CONTAINED**  
...
| **Stage 3** | Defense Evasion | `T1070.001` | `Suspicious Event Log Clearing or Security Software Tampering` | **🟢 DETECTED** | `tamper_defense` |
