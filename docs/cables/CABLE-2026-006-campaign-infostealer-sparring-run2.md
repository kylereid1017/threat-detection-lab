---
cable_id: CABLE-2026-006
date: 2026-09-03
author: Kyle Reid
campaign_id: CAMP-2026-002
campaign_name: Infostealer-Sparring-Run2
campaign_type: multi_stage_kill_chain
depth_of_defense_score: 0.80
intercepted: true
interception_stage: "Execution"
...
# Threat Intelligence Cable: CABLE-2026-006

**TLP:** CLEAR | **Date:** 2026-09-03 | **Author:** Kyle Reid  
**Subject:** Multi-Stage Intrusion Campaign Post-Mortem & Defense-in-Depth Analysis: `Infostealer-Sparring-Run2`  
**Campaign ID:** `CAMP-2026-002` | **Outcome:** **CONTAINED**  
...
* **Engineering Impact:** The campaign was **INTERCEPTED at Stage Execution** (`T1204.002`), preventing full objective attainment with a Depth-of-Defense score of **0.80**.
...
|---|---|---|---|---|---|
| **Stage 1** | Initial Access | `T1566.001` | `Suspicious_Active_Content_SVG_Attachment` | **🔴 EVADED** | `prompt_svg_parser_differential` |
| **Stage 2** | Execution | `T1204.002` | `Suspicious Process Spawning From Explorer Run Prompt (ClickFix Pattern)` | **🟢 DETECTED** | `prompt_powershell_syntax` |
...
| **Observed Fact** | Defense Depth | Depth-of-Defense score reached 0.80 across the intrusion sequence. |
